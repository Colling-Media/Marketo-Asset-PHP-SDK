 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CreateLandingPageContentRequest implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = ["Image", "Form", "Rectangle", "Snippet", "RichText", "HTML"];
    ...
    {
        $allowed_values = array('Image', 'Form', 'Rectangle', 'Snippet', 'RichText', 'HTML');
        if ((!in_array($type, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'type', must be one of 'Image', 'Form', 'Rectangle', 'Snippet', 'RichText', 'HTML'");
        }
