 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class UpdateLandingPageContentRequest implements ArrayAccess
{
    ...
    {
        $invalid_properties = [];
        $allowed_values = ["Image", "Form", "Rectangle", "Snippet", "RichText", "HTML", "DynamicContent"];
     ...
     * @param string $image_open_new_window
     * @return $this
     */
    ...
    {
        $allowed_values = array('Image', 'Form', 'Rectangle', 'Snippet', 'RichText', 'HTML', 'DynamicContent');
        if (!is_null($type) && (!in_array($type, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'type', must be one of 'Image', 'Form', 'Rectangle', 'Snippet', 'RichText', 'HTML', 'DynamicContent'");
        }
    ...
    /**
     * Sets width
     * @param string $width width propeirty of the HTML section
     * @return $this
     */
