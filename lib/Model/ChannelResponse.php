 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ChannelResponse implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'id' => 'int',
        'name' => 'string',
        'progression_statuses' => '\CollingMedia\Client\Model\ChannelProgression[]',
        'updated_at' => '\DateTime'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['applicable_program_type'] === null) {
            $invalid_properties[] = "'applicable_program_type' can't be null";
        }
     ...
     * @return \CollingMedia\Client\Model\ChannelProgression[]
     */
     ...
     * @param \CollingMedia\Client\Model\ChannelProgression[] $progression_statuses List of available statuses for members of programs with the channel
     * @return $this
     */
