 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class LandingPageResponse implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['custom_head_html'] === null) {
            $invalid_properties[] = "'custom_head_html' can't be null";
        }
        if ($this->container['facebook_og_tags'] === null) {
            $invalid_properties[] = "'facebook_og_tags' can't be null";
        }
        if ($this->container['robots'] === null) {
            $invalid_properties[] = "'robots' can't be null";
        }
