...
class FileResponse implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'created_at' => '\DateTime',
        'description' => 'string',
        'folder' => '\CollingMedia\Client\Model\FileFolder',
        'id' => 'int',
        'mime_type' => 'string',
        'name' => 'string',
        'size' => 'int',
    ...
    /**
     * Gets folder
     * @return \CollingMedia\Client\Model\FileFolder
     */
    ...
    /**
     * Sets folder
     * @param \CollingMedia\Client\Model\FileFolder $folder JSON representation of parent folder, with members 'id', and 'type' which may be 'Folder' or 'Program'
     * @return $this
     */
