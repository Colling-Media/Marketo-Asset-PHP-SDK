 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class UpdateSnippetDynamicContentRequest implements ArrayAccess
{
    ...
    {
        $invalid_properties = [];
        $allowed_values = ["Typeofcontent.Either'HTML'or'Text'"];
    ...
    /**
     * Sets type
     * @param string $type Type of dynamic content section
     * @return $this
     */
    public function setType($type)
    {
        $allowed_values = array('Typeofcontent.Either'HTML'or'Text'');
        if (!is_null($type) && (!in_array($type, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'type', must be one of 'Typeofcontent.Either'HTML'or'Text''");
        }
    ...
    /**
     * Sets value
     * @param string $value Value of the dynamic content section
     * @return $this
     */
