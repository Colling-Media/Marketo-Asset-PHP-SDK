...
class ApiClient
{
    ...
    {
        if ($url === null) {
            throw new \Error('You must set the URL in the construction.');
        }
     ...
     *
     * @throws \CollingMedia\Client\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers, true)) {
            ...
            $postData = json_encode(\CollingMedia\Client\ObjectSerializer::sanitizeForSerialization($postData));
        }
